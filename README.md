Taller de ProgramaciÃ³n II - TP_ControlVehicular
...
-----------------------------------
- Presentacion
  - WPF (MVVM): vistas, windows, UserControls y ViewModels. Contiene la configuraciÃ³n de DI y arranque (App.xaml.cs).
- Negocio
  - LÃ³gica de negocio: DTOs, servicios (handlers), mappers y reglas de negocio.
- Datos
...
-----------------------------------------
La aplicaciÃ³n lee la cadena de conexiÃ³n desde appsettings.json (clave: DefaultConnection). Ejemplo de connection string para SQL Server:
...
Coloca la secciÃ³n ConnectionStrings en Presentacion/appsettings.json o en el exe folder. No commitear credenciales en el repo.
