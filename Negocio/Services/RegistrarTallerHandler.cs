...
{
    public class RegistrarTallerHandler
    {
        private readonly ITallerRepository _tallerRepository;
        private readonly IMapper _mapper;

        public RegistrarTallerHandler(ITallerRepository tallerRepository, IMapper mapper)
        {
        ...
        {
            await _tallerRepository.AddAsync(taller);
